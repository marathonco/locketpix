<template>
  <main class="start">
    <section class="instructions">
      <h3>Welcome!</h3>
      <p>This is a free tool to help you resize and print images for your locket! Follow these steps to find the correct size for your Locket.</p>
    </section>
...
export default {
  ...
  methods: {
    ...
    choose() {
      this.$router.push({ path: '/choose/shape' })
    }
  }
}
</script>
