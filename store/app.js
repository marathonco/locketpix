  ...
  ADD_IMAGE(state, payload) {
    const newID =
      state.images.length === 0
        ? 0
        : state.images[state.images.length - 1].id + 1
    const image = {
      id: newID,
